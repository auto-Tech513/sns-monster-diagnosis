(function () {
    ...
    const labels = {
        ...
        zh: { select: "语言", back: "返回诊断", columns: "返回专栏", privacy: "隐私政策", contact: "联系我们", about: "运营信息", articles: "认同感专栏", ad: "赞助链接", btnPermanentSave: "✦ 保存详细AI诊断书＋永久保存 ¥120", btnLockPurchase: "✦ 保存详细AI诊断书＋永久保存 ¥120", orDivider: "─── 或者 ───", btnCompatibility: "想再窥探一点吗？¥360", sectionCompatTitle: "💖 配对诊断结果", sectionGoodMatch: "💚 最佳搭档", sectionBadMatch: "💔 冲突类型", sectionLoveStyle: "📖 你的恋爱观" }
    };
